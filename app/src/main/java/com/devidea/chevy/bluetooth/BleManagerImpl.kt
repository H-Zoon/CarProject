...
import android.app.Service.BLUETOOTH_SERVICE
    ...
    private val scanCallback = object : ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult) {
            ...
            try {
                ...
                Logger.i { "Device found name: $name, address: $address" }
                if ((name != null && (name == BT_NAME1 || name == BT_NAME2))) {
                    Logger.i { "Target device found!" }
                    scanJob?.cancel()
